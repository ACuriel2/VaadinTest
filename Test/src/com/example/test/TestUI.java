...
public class TestUI extends UI {
	...
	final BeanItemContainer<CsdBean> beanContainer = new BeanItemContainer<CsdBean>(CsdBean.class, createFakeCsds());
	...
	protected void init(final VaadinRequest request) {
		...
		newCSDButton.addClickListener(new ClickListener() {
			...
			public void buttonClick(final ClickEvent event) {
				CsdBeanUpdater updater = new CsdBeanUpdaterImp(beanContainer);
				addWindow((new CsdWindowBuilder(updater)).build());
			}
		});
